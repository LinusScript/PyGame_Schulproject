...
class MainMenu:
    def __init__(self, screen: pygame.Surface, title: str = "Pac-Man"):
        ...
        self.options = ["Spiel starten", "Beenden"]
    ...
    def draw(self) -> None:
        ...
        subtitle_surface = self.help_font.render("Hauptmenü", True, self.help_color)
        ...
        help_surface = self.help_font.render(
            "Pfeiltasten/W/S = Auswahl | Enter = Bestätigen | Esc = Beenden",
            True,
            self.help_color,
        )
